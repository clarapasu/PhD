...
# the stable values used in Analysis1.R. The results make up Table 3.2 of the thesis. 
#
 ...
 for (space in space_list){
   for (L in L_list){
     ...
     # ----------------------------------------------------------------------
        ...
        theta_est<-fit$par
        Likelihood.m <- LikelihoodC(theta_est,traps,ddfmat, dfrows, meshmat, T_days)
...
# Display the results (Extract time_MSCR and Likelihood_MSCR to obtain Table 3.2)
print(results)
