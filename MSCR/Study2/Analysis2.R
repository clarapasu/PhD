# ==============================================================================
# ANALYSIS OF PINE MARTEN DATA SET (SURVEY 2)
# By Clara Panchaud
# ==============================================================================
# This analysis fits the data of the Survey 2 of American martens with two different models:
...
#
# The results make up Table 3.5 of the thesis. 
# ==============================================================================
...
trap <- trap[-31,]  # Remove the last element as it was repeated by make.poly
...
A = a*dim(mask)[1] # Total area covered by the mask (95.44 km^2)
meshmat<-as.matrix(mask)
traps<-as.matrix(traps)

# ==============================================================================
# PLOTTING THE LANDSCAPE
# Code to uncomment to produce Figure 1.1(b) of the thesis 
# =================
# 
...
T_days<-11                      # Known survey duration (days)
